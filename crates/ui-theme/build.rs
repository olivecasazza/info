...
fn main() {
    ...
    let json_str = fs::read_to_string("themeColors.json").expect("Failed to read themeColors.json");

    let json: serde_json::Value =
        serde_json::from_str(&json_str).expect("Failed to parse themeColors.json");
