...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function Wh(){return new Yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vu(),fragmentShader:`
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function Xh(){return new Yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vu(),fragmentShader:`
